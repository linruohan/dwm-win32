...
static const wchar_t *fontname = L"FantasqueSansM Nerd Font";
static const unsigned int fontsize = 28;

/* appearance, colors are specified in the form 0x00bbggrr or with the RGB(r, g,
 * b) macro */
#define normbordercolor 0x00cdbcd2
#define normbgcolor 0x003f3430
#define normfgcolor 0x00a0a0a0
#define selbordercolor 0x00cdbcd2
#define selbgcolor 0x00675650
#define selfgcolor 0x00cdbcd2

static const unsigned int borderpx = 0; /* border pixel of windows */
static const unsigned int textmargin =
    18;                           /* margin for the text displayed on the bar */
static bool showbar = true;       /* false means no bar */
static bool topbar = true;        /* false means bottom bar */
static bool showclock = true;     /* false means no clock */
static bool showutcclock = false; /* false means no utc clock */
static bool showexploreronstart =
    true; /* false means do not show explorer/task bar on start */
...
static Rule rules[] = {
    /* class                                 title                  processname
       tags mask   isfloating      ignoreborder */
    {L"MultitaskingViewFrame", NULL, NULL, 0, true, true},
    {L"MSCTFIME UI", NULL, NULL, 0, true, true},
    {L"Microsoft-Windows-SnipperToolbar", L"Snipping Tool", NULL, 0, true,
     true},
    ...
    {L"OperationStatusWindow", NULL, NULL, 0, false,
     true},                                        /* explorer copy window */
    {L"EXCEL", NULL, L"EXCEL.EXE", 0, true, true}, /* Excel */
    {L"XLMAIN", NULL,
     L"C:\Program Files\Microsoft Office\root\Office16\EXCEL.EXE", 0, true,
     true},                                         /* Excel */
    ...
    {NULL, L"spyglass", NULL, 0, true,
     true}, /* https://github.com/a5huynh/spyglass */
    {L"TaskManagerWindow", NULL, NULL, 0, true, true},
    {L"Windows.Ul.Core.CoreWindow", NULL, NULL, 0, true, true},
    {L"Windows.Ul.Core.CoreWindow", NULL, L"ShellExperienceHost.exe", 0, true,
     true},
    ...
    {NULL, NULL, L"WindowsTerminal.exe", 0, true, false},
};
...
static Layout layouts[] = {
    ...
    {L"T", tile},     {L"F", NULL}, /* no layout function means floating
                                       behavior */
    {L"TTT", bstack}, {L"G", gaplessgrid}, {L"g", grid},
    {L"(@)", spiral}, {L"[\\]", dwindle},
};
...
static wchar_t clockfmt[] = L"%y-%m-%d %H:%M:%S %A";
static int clock_interval = 1000;

/* helper for spawning shell commands in the pre dwm-5.0 fashion */
#define SHCMD(cmd)                                                             \
  {                                                                            \
    .v = (const wchar_t *[]) { L"/bin/bash", L"-c", cmd, NULL }                \
  }

/* commands */
static const wchar_t *explorer[] = {L"explorer.exe", NULL};
static const wchar_t *browser[] = {L"firefox.exe", NULL};
static const wchar_t *terminal[] = {L"alacritty.exe", NULL};
...
static Key keys[] = {
    ...
    {MODKEY, 'T', setlayout, {.v = &layouts[1]}},
    {MODKEY, 'F', setlayout, {.v = &layouts[2]}},
    ...
    {MODKEY, 'C', spawn, {.v = browser}},
    {MODKEY, VK_RETURN, spawn, {.v = terminal}},
    ...
    TAGKEYS('1', 0) TAGKEYS('2', 1) TAGKEYS('3', 2) TAGKEYS('4', 3)
        TAGKEYS('5', 4) TAGKEYS('6', 5) TAGKEYS('7', 6) TAGKEYS('8', 7)
            TAGKEYS('9', 8){MODKEY | MOD_CONTROL, 'R', quit, {1}},
